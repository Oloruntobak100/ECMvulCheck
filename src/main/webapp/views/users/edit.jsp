...
<%
    ...
    if( jpet.has( "id" ) && !jpet.getString( "id" ).isEmpty() ){
        if( jget.has( "nwp2_source" ) && jget.has( "nwp2_todo" ) ){
            ...
            //if checking api
            if( canUpdateEmployeeDetailsFromAPI( new JSONObject().put("source", "edit_" + jget.getString( "nwp2_source" ) ) ) ){
            ...
            if( rd.has( "saved_record" ) && rd.getJSONObject( "saved_record" ).has( "id" ) ){
                ...
                JSONObject rd2 = updateEmployeeDetailsFromAPI(
                        new JSONObject()
                                ...
                                .put("source", "edit_" + jget.getString( "nwp2_source" ) )
            ...
            out.print( "No table specified in " + request.getAttribute("filename") );
        }
    }else{
        out.print( "No record id specified in " + request.getAttribute("filename") );
    }
%>