									...
									if( $('textarea[name="'+ dm + '"]') ){
										...
										if( ! $.isEmptyObject( jd ) ){
											$.each(jd, function( jk, jv ){
												h += '<div style="color:#ff6600; margin-bottom:4px;">'+ jv.oname +' <a id="uploaded-'+ jk +'" data-name="'+ responseJSON.element +'" data-stored_name="'+ jv.stored_name +'" href="#" class="pull-right btn btn-sm dark" title="Delete uploaded file" onclick="$.fn.cProcessForm.removeUploadedFile( '+ "'"+ jk +"'" +' );"><i class="icon-trash"></i></a></div>';
											});
										}
