        ...
        initIntro: function () {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    title: 'EMRS DEMO',
                    // (string | mandatory) the text inside the notification
                    text: 'EMRS Demo showcases Client In-take form, Test Requests & Results for HTC & Also OVC Enrollment Form, Access Control, Mobile Adaptable, Modular Nature, Authentication & Data Export Capabilities',
                    // (string | optional) the image to display on the left
                    image: './assets/img/avatar1.jpg',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
