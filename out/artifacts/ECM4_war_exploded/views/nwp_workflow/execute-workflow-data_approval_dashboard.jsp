...
<div nwp-file="<%out.print( request.getAttribute("filename") );%>"  class="hyella-source-container">
    <%
        ...
        try{
            ...
            if( GlobalFunctions.app_user_data.has("group_text") ){
                $dataset.put( new JSONObject().put("title", "Group").put("value", GlobalFunctions.app_user_data.getString("group_text")  ));
            }

            if( GlobalFunctions.app_user_data.has("team_text") ){
                $dataset.put( new JSONObject().put("title", "Team").put("value", GlobalFunctions.app_user_data.getString("team_text")  ));
            }
