...
<%
    ...
    if( jget.has("nwp2_source") && jget.has("nwp2_todo")  ){
        ...
        html += "<form id=\"select-ad-user-form\" method=\"post\" action=\"?action=display_menu&todo=new_user_form&nwp2_action="+jget.getString("nwp2_source")+"&nwp2_todo=new_user_form&nwp2_source="+ jget.getString("nwp2_source") +"&html_replacement_selector=selected-ad-user-con\" class=\"activate-ajax \">";
        html += "<div class=\"row\">";
